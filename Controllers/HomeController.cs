...
namespace AppOwnsData.Controllers {
  ...
  public class HomeController : Controller {
    ...
    public string[] GetUserRoles() {      
     ...
     // demo note: you will need to replace these GUIDs with the group IDs from your tenant 
    ...
    public bool UserCanCustomizeReport() {
        // demo note: you will need to replacethis GUID with the group ID from your tenant 
